...
- [x] 2.4 POST creates a schedule row + 7 schedule_days rows (verify in Studio) — 6bc693f
- [x] 2.5 Empty collection redirects with the Polish error and creates nothing — 6bc693f
- [x] 2.6 Generated schedule is visible only to its owner (RLS holds) — 6bc693f

### Phase 3: Schedule view + entry point + nav

#### Automated

- [x] 3.1 Type checking passes: `npx astro sync && npx astro check` — 6bc693f
- [x] 3.2 Linting passes: `npm run lint` — 6bc693f
- [x] 3.3 Production build succeeds: `npm run build` — 6bc693f

#### Manual

- [x] 3.4 "Harmonogramy" link appears when signed in and routes to /schedules — 6bc693f
- [x] 3.5 Unauthenticated direct navigation to /schedules redirects to /auth/signin — 6bc693f
- [x] 3.6 ≥7 varied recipes → 7-day plan, no adjacent duplicate meals, all filled — 6bc693f
- [x] 3.7 3 recipes → all 7 days filled, repeats non-adjacent — 6bc693f
- [x] 3.8 Pressing generate twice yields different orderings — 6bc693f
- [x] 3.9 Latest schedule renders inline; older schedules link to correct detail page — 6bc693f
- [x] 3.10 Schedules persist across re-login — 6bc693f
- [x] 3.11 All copy is Polish; theme matches the recipes page — 6bc693f
- [x] 3.12 Empty-collection case shows the Polish error and creates nothing — 6bc693f
